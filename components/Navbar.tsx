    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* CTA Button */}
          <div className="hidden md:block">
            <button className="bg-nexus-700 hover:bg-nexus-600 text-nexus-accent border border-nexus-600 hover:border-nexus-accent/50 px-5 py-2 rounded-full text-sm font-semibold transition-all duration-300 shadow-lg shadow-black/20">
              Login
            </button>
          </div>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-nexus-900 border-b border-nexus-600">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pt-4 pb-2">
              <button className="w-full text-center bg-nexus-700 text-nexus-accent py-3 rounded-md font-semibold">
                Login
              </button>
            </div>
          </div>
